...
export const AttendanceSheet: React.FC = () => {
  ...
  const { markAttendance, getWeeklyAttendance, getMonthlyAttendance } =
    useAttendance();
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-purple-600">
                  {attendanceData.grandTotals.totalRegularHours}h
                </p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-orange-600">
                  {attendanceData.grandTotals.totalExtraHours}h
                </p>
              </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center">
            ...
            Folha de Presença KAMA -{" "}
            {viewType === "weekly" ? "Semanal" : "Mensal"}
          </CardTitle>
        </CardHeader>
        <CardContent>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200">
                  ...
                  <th className="text-center py-3 px-4 font-medium text-gray-900 bg-green-50">
                    H. Reg.
                  </th>
                  <th className="text-center py-3 px-4 font-medium text-gray-900 bg-orange-50">
                    H. Extra
                  </th>
                  <th className="text-center py-3 px-4 font-medium text-gray-900 bg-purple-50">
                    Total
                  </th>
                </tr>
              </thead>
      ...
      >
        <div className="p-6 space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setTimeData((prev) => ({ ...prev, clockIn: e.target.value }))
                }
              />
            </div>
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setTimeData((prev) => ({ ...prev, clockOut: e.target.value }))
                }
              />
            </div>
            <div>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setTimeData((prev) => ({ ...prev, breakEnd: e.target.value }))
                }
              />
            </div>
          </div>
          ...
          <div className="flex justify-end space-x-3 pt-4 border-t border-gray-200">
            ...
            <Button onClick={handleTimeSubmit}>Confirmar Presença</Button>
          </div>
        </div>
      </Modal>
    </div>
